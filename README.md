...
Next, install this generator:
    ...
    npm install -g generator-fbp-angular
...
Running a generator:
    ...
    yo fbp-angular:directive my-awesome-directive
    yo fbp-angular:partial my-partial
    yo fbp-angular:service my-service
    yo fbp-angular:filter my-filter
    yo fbp-angular:module my-module
    yo fbp-angular:modal my-modal
...
Submodules allow you to more explicitly separate parts of your application.  Use the `yo fbp-angular:module my-module` command and specify a new subdirectory to place the module into.  Once you've created a submodule, running other subgenerators will now prompt you to select the module in which to place the new component.
...
* 9/06/2013 - V1.0.4 - Fixed templating issue with generated specs for `yo fbp-angular:service` subgenerator.
